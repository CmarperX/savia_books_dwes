...
<head>
    ...
    <title>Savia Books - Register</title>
...
<body data-shorcut-listen="true">
    ...
    <nav class="mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../login/login.php">Login</a></li>
    ...
    <div class="container d-flex justify-content-center align-items-center"> 
        <div class="shadow-sm p-4">
            ...
            <form action="register.php" method="post">
              ...
              <div class="mb-3">
                    <label for="surname" class="form-label mb-2">Surname</label>
              ...
              <div class="mb-3">
                    <label for="locality" class="form-label mb-2">Locality</label>
                    <input type="text" class="form-control" name="locality" placeholder="Locality" required>
              </div>
              <div class="mb-3">
                    <label for="province" class="form-label mb-2">province</label>
                    <input type="text" class="form-control" name="provincia" placeholder="Province" required>
              </div>
              <div class="mb-3">
                    <label for="phone" class="form-label mb-2">Phone</label>
                    <input type="text" class="form-control" name="phone" placeholder="Phone" maxlength="9" required>
              </div>
              <div class="mb-3">
