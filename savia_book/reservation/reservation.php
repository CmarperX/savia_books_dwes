...
<head>
    ...
    <title>Savia Books - Reserves</title>
...
<body data-shorcut-listen="true">
    ...
    <nav class="mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Reserves</li>
        </ol>
    </nav>
    <!-- RESERVATION FORM-->
    <div class="container"> 
        <h3 class="text-center mb-3">Reserve your book</h3>
        <div class="row justify-content-center">
            <div class="col-md-8 p-5">
                <form action="reservation.php" method="post">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="loan-date" class="form-label mb-2">Loan Date</label>
                            <input type="date" class="form-control" name="loan-date" required>
                        </div>
                        <div class="col-md-6">
                            <label for="due-date" class="form-label mb-2">Due Date</label>
                            <input type="date" class="form-control" name="due-date" required>
                        </div>
                        <!-- CHOOSE BOOK -->
                        <div class="mb-3">
                            <label for="book" class="form-label mb-2">Book</label>
                            <select id="book" name="book" class="form-select" required>
                                <option value="" selected disabled>Select a book</option>
                                <option value="orient_express">Murder on the Orient Express</option>
                                <option value="hobbit">The Hobbit</option>
                                <option value="prince_mist">The Prince of Mist</option>
                            </select>
                        </div>
                        <!-- TERMS & CONDITIONS -->
                        <div class="form-check mb-4">
                            ...
                            I agree to the loan conditions
                            </label>
                        </div>
