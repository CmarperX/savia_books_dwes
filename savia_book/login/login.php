      ...
      <div class="shadow-sm p-4">
        ...
        <form action="login.php" method="post">
          ...
          <button class="btn btn-primary w-100 py-2">
            <a href="../user/home.html" type="submit" style="text-decoration: none; color: white;">
            Sign in
            </a>
          </button>
        </form>
        <a class="btn btn-primary w-100 my-2 py-2" href="../register/register.php" style="text-decoration: none; color: white;">
            Register
        </a>
        <div class="form-check text-start my-3">
            <a href="../forget/forget-password.php" style="text-decoration: none;">
