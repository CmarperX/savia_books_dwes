...
<body data-shorcut-listen="true">
    ...
    <div class="container my-5">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <img src="../images/tienda.jpeg" alt="Savia Books Store" width="50%" class="img-fluid shadow-lg d-block mx-auto">
            </div>
        </div>
        <div class="row mt-5">
        ...
        <div class="row mt-5">
            <div class="col-lg-8 mx-auto text-center p-5 rounded shadow">
                ...
                <a class="btn btn-lg fw-bold btn-primary text-white" href="../catalog/catalog.php">Explore Catalog</a>
            </div>
        </div>
    </div>
