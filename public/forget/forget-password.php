...
<body data-shorcut-listen="true">
    ...
    <nav class="mb-4 ms-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../login/login.php" style="text-decoration:none; color:var(--primary-color);">Login</a></li>
    ...
    <div class="container d-flex justify-content-center align-items-center"> 
        <div class="shadow-sm p-4">
            <h3 class="text-center mb-3">Recover Password</h3>
            <form action="forget-password.php" method="post">
                ...
                <button class="btn btn-primary w-100 py-2">
                    <a href="../login/login.php" type="submit" style="text-decoration: none; color: white;">
                    Recover Password
                    </a>
                </button>
            </form>
            <div class="form-check text-start my-3">
            <a href="../login/login.php" style="text-decoration: none; color:var(--primary-color)">
            Back to the Login
            </a>
        </div>
        </div>
