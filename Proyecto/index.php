...
<body class="d-flex flex-column min-vh-100" data-shorcut-listen="true">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <h5 class="fw-bold">Bienvenido a Savia Books <br> Donde cada historia comienza a florecer.</h5>
                    <p class="fs-6">Descubra un espacio creado para lectores que buscan inspiración, crecimiento 
                        y una conexión significativa con el mundo que los rodea.
                    </p>
                    <p><a class="btn btn-primary btn-lg fw-bold" href="catalog.php">Explorar catálogo</a></p>
                </div>
            </div>
            <!-- Slide 2 -->
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h5 class="fw-bold">Miles de libros para nutrir tu mente y tu imaginación..</h5>
                    <p class="fs-6">Novelas, ensayos, cuentos infantiles y los últimos lanzamientos literarios, todo pensado para lectores apasionados..</p>
                    <p><a class="btn btn-primary btn-lg fw-bold" href="catalog.php">Descubra nuevas lecturas</a></p>
                </div>
            </div>
            <!-- Slide 3 -->
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h5 class="fw-bold">Lectura sostenible porque los libros también pueden cuidar el planeta.</h5>
                    <p class="fs-6">Apoyamos a editoriales responsables, materiales ecológicos y una filosofía respetuosa con el medio ambiente.</p>
                    <p><a class="btn btn-primary btn-lg fw-bold" href="about-us.php">Más información</a></p>
                </div>
            </div>
        </div>
    ...
    <section class="container my-5">
        <h2 class="text-center mb-4 section-title fw-bold">¿Qué es Savia Books?</h2>
        <p class="lead text-center mx-auto" style="max-width:800px;">
            Savia Savia Books es una librería digital sostenible diseñada para ofrecer una experiencia de lectura inspiradora y respetuosa con el medio ambiente. 
            Nuestra misión es dar vida a las historias mientras cuidamos nuestro planeta.
        </p>
    </section>
    <!-- CARDS -->
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm text-center"> <!-- h-100 hace que todas las cards tengan la misma altura -->
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">Amplio catálogo de libros</h5>
                        <p class="card-text">Miles de títulos de todos los géneros para alimentar tu pasión por la lectura.</p>
                    </div>
                </div>
            </div>
            <!-- CARD 2 -->
            <div class="col-md-4">
                <div class="card h-100 shadow-sm text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">Filosofía Sostenible</h5>
                        <p class="card-text">Promovemos materiales ecológicos y apoyamos a editores responsables.</p>
                    </div>
                </div>
            </div>
            <!-- CARD 3 -->
            <div class="col-md-4">
                <div class="card h-100 shadow-sm text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">Experiencia fácil de usar</h5>
                        <p class="card-text">Aquiere libros, personaliza tu perfil y descubre recomendaciones seleccionadas.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="p-5 text-center">
        <h2 class="fw-bold" >¿Listo para comenzar tu viaje?</h2>
        <p>Crea tu cuenta y descubre un mundo de historias sostenibles.</p>
        <a href="user/register.php" class="btn btn-primary btn-lg fw-bold">Crear cuenta</a>
    </section>
    <!-- Footer -->
